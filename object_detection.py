...
class ObjectDetection:
    def __init__(self):
        ...
        md.setPreferableBackend(cv2.dnn.DNN_BACKEND_CUDA)
        md.setPreferableTarget(cv2.dnn.DNN_TARGET_CUDA)
    ...
    def detectObj(self, snap):
        ...
        blob = cv2.dnn.blobFromImage(snap, 1/255, (416, 416), swapRB=True, crop=False) # create blob from image to transfer to your cnn
        ...
        for out in outs:
            for detection in out:
                ...
                if confidence > 0.99: # if confidence is higher than 50%
                    # Object detected
                    ...
                    try:
                        ...
                        print(self.counter)
                        if self.counter == 10:
                            verificator.addnotregistred(recognize_plate(snap, ocr_boxes))
                            cv2.imwrite('unverified.jpg',snap)
...
def recognize_plate(img, coords):
    ...
    cv2.imwrite('verified.jpg', thresh)
